...
void simulate_reciprocated_krapivsky_model(directed_model_t *krapivsky_model, double r);
...
int main(int argc, char** argv) {
  ...
  simulate_reciprocated_krapivsky_model(krapivsky_model_linear, options->r);
